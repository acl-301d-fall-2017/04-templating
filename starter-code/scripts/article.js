...
Article.prototype.toHtml = function() {
    ...
    const filledOut = template(this);
    
    return filledOut;
};

// COMMENT: Why are there parentheses around "(a,b)" in the .sort() method, but not around the "articleObject" or "article" arguments in the .forEach() methods?
// There are two parameters in the arrow function, which requires () to designate that both variables are parameters. When there is only one parameter, no () is needed.
rawData.sort((a,b) => {
